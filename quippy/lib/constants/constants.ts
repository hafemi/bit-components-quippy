...
export const githubCommandsLink = 'https://github.com/hafemi/bit-components-quippy/blob/master/README.md'
export const discordHelpServerLink = 'https://discord.gg/ae82fnA53z';